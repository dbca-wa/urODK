...
urODK is the companion package to [ruODK]((https://dbca-wa.github.io/ruODK/)), 
...
Before we start, read the brief [overview](https://dbca-wa.github.io/ruODK/) of
electronic data capture using OpenDataKit, and how ruODK fits into that picture.
...
* [Build a form](https://docs.opendatakit.org/build-intro/#form-building), 
  save, [export as XML](https://docs.opendatakit.org/build-intro/#export-forms). 
  (10 min)
...
[ruODK example forms](https://github.com/dbca-wa/ruODK/tree/master/inst/extdata).
...
* Request an account at the [ODK Central Sandbox](https://sandbox.central.opendatakit.org/#/login?next=%2F)
  * by asking [@yanokwa](https://forum.opendatakit.org/u/yanokwa/summary) 
...
* Configure ruODK through .Renviron (ODK Central Sandbox un,pw, default project/form). (5 min)
...
To install urODK in your own environment, run this (preferably ahead of the 
workshop):
...
chunk with the OData service URL. Note: the `paste0()` is cosmetic and optional.
...
ruODK's template "OData", or run the next chunk with a filename of your choice:
