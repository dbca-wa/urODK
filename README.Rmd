...
Fail-safe: ruODK comes with a few example forms, including the one used in the
package vignettes. 
See [extdata](https://github.com/dbca-wa/ruODK/tree/master/inst/extdata) for 
other forms provided by ruODK.
...
* Request an account at the [ODK Central Sandbox](https://sandbox.central.opendatakit.org/#/login?next=%2F)
  * by asking @yawanokwa on the [ODK Forum](https://forum.opendatakit.org/)
